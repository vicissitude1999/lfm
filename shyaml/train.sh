...
# evaluating on cifar100 using architectures searched on cifar10
#python train.py --set cifar100 --batch_size 220 --auxiliary --cutout --arch pcdarts_lfm_cifar10_1
#python train.py --set cifar100 --batch_size 260 --auxiliary --cutout --arch pcdarts_lfm_cifar10_2
#python train.py --set cifar100 --batch_size 210 --auxiliary --cutout --arch pcdarts_lfm_cifar10_3
